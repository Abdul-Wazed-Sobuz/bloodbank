...
if(isset($_POST['save']))
{
    ...
    if($result){
        ...
        $query2=oci_parse($conn,"insert into HOSPITAL(hospital_name,hospital_phone,hospital_address,hospital_email,account_id) values('$hospital_name','$hospital_phone','$hospital_address','$email','$account_id')");   
